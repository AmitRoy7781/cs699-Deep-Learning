...
#     d_train = torch.zeros(num_nodes)
#     d_val = torch.zeros(num_nodes)
#     d_test = torch.zeros(num_nodes)
    
    
#     for edge in edge_pos_train:
#         u,v = edge[0], edge[1]
#         d_train[v] = d_train[v] + 1
        
#     for edge in edge_pos_valid:
#         u,v = edge[0], edge[1]
#         d_val[v] = d_val[v] + 1
        
#     for edge in edge_pos_test:
#         u,v = edge[0], edge[1]
#         d_test[v] = d_test[v] + 1
        
#     print("Train Nodes ")
#     print("Min :", min(d_train), " Max: ", max(d_train), " Avg: ", torch.sum(d_train)/num_nodes )
#     print("Val Nodes ")
#     print("Min :", min(d_val), " Max: ", max(d_val), " Avg: ", torch.sum(d_val)/num_nodes )
#     print("Test Nodes ")
#     print("Min :", min(d_test), " Max: ", max(d_test), " Avg: ", torch.sum(d_test)/num_nodes )
