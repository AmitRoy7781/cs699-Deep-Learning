...
\newcommand{\website}{{\tiny\url{https://www.cs.purdue.edu/homes/ribeirob/courses/Spring2022}}}
\newcommand{\homeworknumber}{1}
\newcommand{\duedate}{ {\bf 11:59pm}, Friday, February 14th (open until 6:00am next day)}
\newcommand{\code}{}
...
\begin{tikzpicture}[%
  ...
  \node {bruno\_ribeiro\_hw\homeworknumber}
    ...
    child { node {hw\homeworknumber\_rotation\_invariant\_MLP.py} };
\end{tikzpicture}
